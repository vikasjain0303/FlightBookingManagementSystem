...
namespace CommonServiceDiscovery
{
    public static class AppExtensions
    {
        ...
        public static IApplicationBuilder UseConsul(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            //consulClient.Agent.ServiceDeregister("productService-id").ConfigureAwait(true);

            //consulClient.Agent.ServiceDeregister("catalogService-id").ConfigureAwait(true);
